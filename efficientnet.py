...
out='./model_wt/Efficientnet/2july_torch-cn_cj'
...
train_dataset = patchdataset(path='/workspace/hnsc_for_tumor/tum_ntum/tum_ntum1/data_256_g_train.csv',transforms=torch_transform)
val_dataset = patchdataset_test(path='/workspace/hnsc_for_tumor/tum_ntum/tum_ntum1/data_256_test.csv' ,transforms=torch_transform1)
